/**
 * setup-async.js - Initialize the Kuzu database with schema and sample data
 * This version uses the async query method which returns a Promise
 */
...
// Schema creation helper function using Promise-based query method
...
setupDatabase()
  .then(() => {
    ...
    return conn.query('CALL show_tables() RETURN *')
      .then(res => res.getAll())
      .then(tables => {
